        ...
        <div class="widget">
            <div class="wiz_form">
                ...
                <div class=" fluid">
                    <div class="formRow ">
                        <div class="grid4">
                            <label>Имя</label></div><div class="grid8">
                            <input placeholder="Введите ваше имя" type="text" name="JoinYouTubersNew[name]" id="JoinYouTubersNew_name" class="<?=(($form->error($model,'name') != '') ? 'error' : '')?>">
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="formRow ">
                        <div class="grid4">
                            <label>E-mail</label></div><div class="grid8">
                            <input placeholder="Введите ваш E-mail" type="text" name="JoinYouTubersNew[email]" id="JoinYouTubersNew_email" class="<?=(($form->error($model,'email') != '') ? 'error' : '')?>">
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="formRow  noBorderB">
                        <div class="formSubmit">
                            <input class="buttonXL bGreen" type="submit" name="yt0" value="Продолжить" onclick="mixpanel.track('Ютюбер ввел имя и Email',{'email':document.getElementById('JoinYouTubersNew_email').value})">
                        </div>
                        <div class="clear"></div>
                    </div>
                </div>
