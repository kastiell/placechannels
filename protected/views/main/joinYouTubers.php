                ...
                <div class=" fluid"><div class="formRow ">
                        ...
                        <div class="formRow  noBorderB">
                            <div class="formSubmit">
                                <input class="buttonXL bGreen" type="submit" name="yt0" value="Продолжить"
                                       onclick="mixpanel.track('Ютюбер ввел телефон и нажал продолжить',{'phone':document.getElementById('JoinYouTubers_phone').value})">
                            </div>
                            <div class="clear"></div>
                        </div>
                </div>
